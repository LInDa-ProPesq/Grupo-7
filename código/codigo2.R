...
usoacademico
lbls <- c("Não","Sim", "Sim, porem com restrições", "Nao sei / Não tenho opinião")
...
par(bg = "light blue")
pie(profchegaal, labels = lbls, edges = 100, angle = 45, border = NULL, lty = NULL, main = "Midia social é a melhor forma de aproximição?")
dev.off()
...
par(bg = "light blue")
pie(melhoraresul, labels = lbls, edges = 100, angle = 45, border = NULL, lty = NULL, main = "Melhores resultados serão alcançados com a integração?")
dev.off()
